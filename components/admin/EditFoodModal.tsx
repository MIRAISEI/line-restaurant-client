...
import { updateMenuItem, getCategories, type MenuItem, type Category } from "@/lib/admin-api";
  ...
  const addonItems = useMemo(() => {
    return menuItems.filter(
      (menuItem) =>
        ...
        (menuItem.nameEn.toLowerCase().includes(addonSearch.toLowerCase()) ||
          menuItem.nameJp.toLowerCase().includes(addonSearch.toLowerCase()))
    );
  }, [menuItems, item, addonSearch]);
                      ...
                      <div className="absolute z-20 w-full mt-1 bg-white border-2 border-gray-200 rounded-xl shadow-lg max-h-64 overflow-hidden flex flex-col">
                        ...
                        <div className="p-2 border-b border-gray-200">
                          <input
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#06C755]/20"
                            autoFocus
                          />
                        </div>
                        {/* Category list */}
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <div className="relative w-full sm:w-64">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 text-sm border-2 border-gray-200 rounded-xl focus:border-[#06C755] focus:outline-none transition-all"
                    />
                  </div>
                </div>
                  ...
                  {Object.keys(groupedAddons).length === 0 ? (
                    ...
                    Object.entries(groupedAddons).map(([category, addons]) => (
                      <div key={category} className="p-4">
                        <h5 className="text-xs font-bold text-[#06C755] uppercase tracking-widest mb-3 flex items-center gap-2">
                          ...
                          {addons.map((addon) => (
                            ...
                            >
                              ...
                              <input
                                ...
                                className="w-5 h-5 rounded border-2 border-gray-300 text-[#06C755] focus:ring-2 focus:ring-[#06C755]/20 focus:ring-offset-0"
                              />
                            </label>
                          ))}
                        </div>
